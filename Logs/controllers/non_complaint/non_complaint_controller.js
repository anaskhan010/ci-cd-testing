...
//         `SELECT study_enrolled_id, organization_detail_id FROM organization WHERE user_id = ?`,
//         [userId]
//       );
...
//       const { study_enrolled_id, organization_detail_id } = orgInfo[0];
//       console.log(orgInfo[0], "====check organization info=====");
//       filters = { study_enrolled_id, organization_detail_id };
//     }

//     // Get non-compliant patients based on the new logic
//     const result = await nonComplaintModel.non_complaint_model(filters);
//     // console.log("Non-compliant patients:", result);
...
//     // For each non-compliant patient, send email to users (except Subjects) in the same study/site.
//     for (let patient of newResult) {
//       const { study_enrolled_id, organization_detail_id, ecrf_id } = patient;
...
//         [study_enrolled_id, organization_detail_id]
//       );
//       console.log("==============================================");
//       console.log(recipients, "==========check medicine recipient=========");
//       for (let recipient of recipients) {
//         // Construct the email text content
//         const emailText = `Patient has not submitted their medicine intake record for at least 3 consecutive days.`;
//         // Call sendEmail with parameters: to, subject, text, firstName, lastName
//         await sendEmail(
//           recipient.email,
